...
let
  ...
  versions.aarch64-darwin = "5.12.2.11434";
  versions.x86_64-darwin = "5.12.2.11434";
  ...
  srcs = {
    aarch64-darwin = fetchurl {
      ...
      hash = "sha256-cxZT34HYXRHmEVQasIjVkZdhH3haqDQbuYaJ8zKjx3Y=";
    };
    x86_64-darwin = fetchurl {
      url = "https://zoom.us/client/${versions.x86_64-darwin}/zoomusInstallerFull.pkg";
      hash = "sha256-aDkE/uLkuSVMnvi6+GXachHPk+gNmeJkBp0G31Y2Kv4=";
    };
